...
headers = {
    ...
    'Referer': 'https://domoplaner.ru/catalog/355/NOK5p4/?start=1&domain=aHR0cHM6Ly94bi0tYjFhZ2plYmNrcWN1aDlkLnhuLS1wMWFp&back=1&state=plans',
...
response = requests.get('https://domoplaner.ru/widget-api/widget/355-NOK5p4/', cookies=cookies, headers=headers)
...
for i in items:
    ...
    try:
        ...
        price = ''
    section = i['section_title'].replace('Секция ', '')
    try:
