...
while True:
    ...
    if page_counter == 1:
        url = f'https://www.green-garden.ru/mos/catalog/zhukovsky-2/'
    else:
        url = f'https://www.green-garden.ru/mos/catalog/zhukovsky-2/?PAGEN_3={page_counter}'
