...
zh_list = ['skandinavskiy', 'dvizhenie', 'datskij-kvartal', '1-salarevskij', 'dvizhenie-govorovo', '1-himkinskij', '1-uzhnyj', '1-donskoj', '1-sheremetevskij', '1-izmajlovskij', 'uznaa-bitca', '1-lermontovskij', '1-leningradskij', 'skygarden', 'rotterdam', 'rezhiser', 'rimskiy']
...
save_flats_to_excel(flats, 'all_projects', 'ФСК')
