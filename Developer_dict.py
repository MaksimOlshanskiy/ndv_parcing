name_dict = {'Сити Микс-Новокосино': 'СитиМикс Новокосино', 'Найс Лофт': 'Найс лофт', 'Cityzen': 'CITYZEN',
             ...
             'LUZHNIKI': 'Luzhniki Collection', 'SOLE HILL (Соул хилл)': 'SOLE HILL',
             ...
             'Олимп 3': 'Олимп-3', 'ПОЛЁТ-Купавна': 'Полет Купавна',
             ...
             'Климашкина 711' : 'Климашкина 7/11',
             'Ильинка 38' : 'Ильинка 3/8',
             'NEXUS' : 'Nexus',
             'Обыденский № 1' : 'Обыденский',
             'Обыденский №1' : 'Обыденский',
             'Чистые Пруды' : 'Чистые пруды',
             'МИРА' : 'Мира',
             'Новые Смыслы' : 'Новые смыслы',
             'СЕТ' : 'Сет',
             'Гостиничный комплекс Варшавские Ворота' : 'Варшавские ворота',
             'Симоновский вал' : 'Симоновский Вал',
             'Трилогия Кристалл в Юнион Парк' : 'Трилогия Кристалл',
             ...
             'River Residences' : 'Ривер Резиденсес',
             'Woods' : 'Вудс',
             'Foreville' : 'Форевиль',
             'ultima' : 'УЛЬТИМА Сити',
             'tate' : 'ТАТЕ',
             'Палашёвский 11' : 'Палашевский 11',
             'ФЕНИКС' : 'Феникс',
             'МУЗА' : 'Муза',
             'МФК СИТИМИКС' :'СИТИМИКС',
             'Михалковский 7' : 'Михалковский',
             'Новые Смыслы от UNIKEY' : 'Новые смыслы',
             'Резиденции архитекторов' : 'Резиденции Архитекторов',
             'Secretgarden': 'Сикрет Гарден',
             'Фрунзенский' : 'Клубный Квартал Фрунзенский',
             'МЫС. Таунхаусы' : 'Мыс',
             'МЫС. Коттеджи' : 'Мыс'
...
developer_dict = {'ООО ТК Алладин': 'ТК Алладин',
                  ...
                  'СЗ СК Ключ': 'СЗ Ключ',
                  'ГК ФСК' : 'ФСК',
                  'СЗ ИНВЕСТ ХИМКИ' : 'ГРАД',
                  'ГК Зеленый сад' : 'Зеленый сад',
                  'СЗ ГРОДНЕНСКАЯ 18' : 'PLATO Development',
                  'СЗ ФОНЧЕНКО' : 'Ant Development',
                  'Balchug Development' : 'ГК БАЛЧУГ ДЕВЕЛОПМЕНТ',
                  'ГК Юникей' : 'Юникей',
                  'ГК СтройИнновация' : 'СтройИнновация',
                  'СПЕЦИАЛИЗИРОВАННЫЙ ЗАСТРОЙЩИК М.О.Д' : 'М.О.Д'
