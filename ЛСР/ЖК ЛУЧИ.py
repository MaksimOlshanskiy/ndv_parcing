...
while True:
    ...
    data = f'last_delivery=30&price%5Bmin%5D=7.1&price%5Bmax%5D=26.3&price_range%5Bmin%5D=7.1&price_range%5Bmax%5D=26.3&obj%5B%5D=52&obj%5B%5D=52&area%5Bmin%5D=20&area%5Bmax%5D=65&area_range%5Bmin%5D=20.0&area_range%5Bmax%5D=65.0&floor%5Bmin%5D=2&floor%5Bmax%5D=24&floor_range%5Bmin%5D=2&floor_range%5Bmax%5D=24&ob[page]={str(page_counter)}&ob[sort]=price&ob[order]=asc&group[t]=false&ob[id]=52&object=52&a=types&ok=7nQ38a9oqA5YE6ye0iPiviXk1D1A3xcC'
