...
while True:
    ...
    data = f'last_delivery=30&price%5Bmin%5D=12&price%5Bmax%5D=96.9&price_range%5Bmin%5D=12.0&price_range%5Bmax%5D=96.9&obj%5B%5D=218&obj%5B%5D=218&area%5Bmin%5D=18&area%5Bmax%5D=127&area_range%5Bmin%5D=18.0&area_range%5Bmax%5D=127.0&floor%5Bmin%5D=3&floor%5Bmax%5D=42&floor_range%5Bmin%5D=3&floor_range%5Bmax%5D=42&ob[page]={str(page_counter)}&ob[sort]=price&ob[order]=asc&group[t]=false&ob[id]=218&object=218&a=types&ok=7nQ38a9oqA5YE6ye0iPiviXk1D1A3xcC'
    ...
    for i in flats_soup:
        ...
        try:
            korpus = i.find('span', class_= 'label l3').text.strip().replace("Дом ", "")
        except ValueError:
...
filename = f"{developer}_{project}2_{current_date}.xlsx"
