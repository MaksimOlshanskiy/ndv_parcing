...
while True:
    ...
    data = f'last_delivery=30&price%5Bmin%5D=13&price%5Bmax%5D=74.3&price_range%5Bmin%5D=13.0&price_range%5Bmax%5D=74.3&obj%5B%5D=211&obj%5B%5D=211&area%5Bmin%5D=22&area%5Bmax%5D=108&area_range%5Bmin%5D=22.0&area_range%5Bmax%5D=108.0&floor%5Bmin%5D=2&floor%5Bmax%5D=57&floor_range%5Bmin%5D=2&floor_range%5Bmax%5D=57&ob[page]={str(page_counter)}&ob[sort]=price&ob[order]=asc&group[t]=false&ob[id]=211&object=211&a=types&ok=7nQ38a9oqA5YE6ye0iPiviXk1D1A3xcC'
    ...
    for i in flats_soup:
        ...
        section = ''
        try:
            floor = int(i.find('div', class_= 'listingCard__label').text.strip().split()[3])
        except:
