...
from functions import merge_and_clean, save_flats_to_excel
...
finishing_list = ['0', '1', '2', '3', '4', '5', '6', '7']
finishing_dict = {'0' : 'Без отделки', '1' : 'С отделкой', '2': 'Без отделки', '3': 'Предчистовая', '4' : 'Предчистовая', '5': 'Предчистовая', '6': 'Без отделки', '7': 'С отделкой'}
...
save_flats_to_excel(flats, 'All_projects', developer)
