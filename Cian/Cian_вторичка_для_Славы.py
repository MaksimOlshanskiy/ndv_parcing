...
'''
    'Москва': 1 -    6 часов
    'Санкт-Петербург': 2 -    4 часа
    'Новосибирск': 4897 -   2,5 часа
    'Екатеринбург': 4743 -   1,5 час
    'Казань': 4777 -   1 час
    'Красноярск': 4827 -   1 час
    'Нижний Новгород': 4885 -   1 час
    'Челябинск': 5048 -   1 час
    'Уфа': 176245 -   1 час
    'Краснодар': 4820 -   2,5 часа
    'Самара': 4966 -   1 часа
    'Ростов-на-Дону': 4959 -   2,5 часа
    'Омск': 4914 -   1,5 час
    'Воронеж': 4713 -   1 часа
    'Пермь': 4927 -   0,5 часа
...
'''
user_input = int(input("\nЕсли начинаем сначала, то введи 1, иначе введи id нужного города: "))

cities_to_parse = [1, 2, 4897, 4743, 4777, 4827, 4885, 5048, 176245, 4820, 4966, 4959, 4914, 4713, 4927, 4704]
...
for city in cities_to_parse[cities_to_parse.index(user_input):]:
    ...
    coords = city_centers.get(city)

    json_data['jsonQuery']['region']['value'] = [city]
            ...
            for f in total_floor_list:
                ...
                while len(flats) < total_count:
                    ...
                    for i in items:
                        ...
                        result = [geo1, geo2, geo3, geo4, distance, adress, rooms_count, area, price, finish_type,
                                  description, property_from, url]
                        flats.append(result)
...
merge_and_clean(base_path, f'Вторичка_милионники_{current_date}.xlsx')
