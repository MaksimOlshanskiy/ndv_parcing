...
region_list = [4593, 4588, 4584, 4596, 4606, 4608, 4618, 4560, 4609, 4619, 181462,
...
areas_ids = [
    471, 464, 422, 453, 456, 459, 467, 458, 437, 451, 450, 447, 440, 446,
    439, 436, 460, 455, 425, 469, 434, 461, 426, 441, 449, 462, 438, 443,
    421, 435, 473, 470, 448, 428, 429, 433, 457, 424, 431, 444, 423, 419,
    454, 445, 468, 465, 420, 463, 452, 432, 430, 442, 466, 427
]
        ...
        for offer_seller_type in offer_seller_types:
            ...
            for area_id in areas_ids:
                ...
                if len(flats) > 0:
                    ...
                    filename = f"Земля_продажа_{region}_{land_status}_{offer_seller_type}_{total_area_list}.xlsx"
