...
types_dict = {1: 'Офис, аренда', 2: 'Торговая площадь, аренда', 3: 'Склад, аренда',
              5: 'Помещение свободного назначения, аренда',
              7: 'Производство, аренда', 11: 'Здание, аренда'}
            ...
            while True:
                ...
                for i in items:
                    ...
                    result = [type_of_lot, location, location2, location3, okrug, raion, mikroraion, metro, street,
                              ...
                              kitchenArea, livingArea, loggiasCount, land_area, land_area_unit_type,
                              possibleToChangeStatus, land_statusl, land_type,
                              buildingType2, buildingClassType, building_name, buildingType, layout, offerType,
                              officeType
                              ]
                    flats.append(result)
