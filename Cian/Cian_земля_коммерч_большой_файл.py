...
type_of_lot = 'Коммерческая земля, продажа'
...
for region in region_list:
    ...
    while True:
        ...
        for i in items:
            ...
            result = [type_of_lot, location, location2, location3, okrug, raion, mikroraion, metro, street, house, adress, rooms_count, area, price, finish_type, description, property_from, url,
                      ...
                      kitchenArea, livingArea, loggiasCount, land_area, land_area_unit_type, possibleToChangeStatus, land_status, land_type
                      ]
            flats.append(result)
    ...
    filename = f"Земля_продажа_{region}_{current_date}.xlsx"
