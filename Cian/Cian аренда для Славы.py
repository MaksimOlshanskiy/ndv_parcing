...
total_floor_list = [[1, 2], [3, 4], [5, 6], [7, 10], [11, 15], [15, 20], [21, 200]]
...
for f in total_floor_list:
    ...
    base_path = r"C:\Users\m.olshanskiy\PycharmProjects\ndv_parsing\Cian\Аренда"

    filename = f"Аренда_Москва_{json_data["jsonQuery"]["floor"]["value"]["lte"]}_{current_date}.xlsx"
...
merge_and_clean(base_path, f'Аренда_Москва_{current_date}.xlsx')
