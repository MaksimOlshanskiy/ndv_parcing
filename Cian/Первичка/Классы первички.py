...
# Загружаем файлы
df1 = pd.read_excel(r"D:\НДВ\Города млн\Август 2026\Первичка\Первичка 07-26.xlsx")
df2 = pd.read_excel(r"D:\НДВ\Города млн\Август 2026\Города-миллионники_классы.xlsx")
...
# сохраняем
result.to_excel("D:\НДВ\Города млн\Август 2026\Первичка с классами.xlsx", index=False)