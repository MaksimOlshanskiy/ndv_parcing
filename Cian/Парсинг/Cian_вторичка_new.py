    ...
    for repair_id in repair_ids:
        ...
        for f in total_floor_list:
            ...
            while len(flats) < total_count:
                ...
                for i in items:
                    ...
                    try:
                        ...
                        distance = ''
                    phone = i['phones'][0]['countryCode']+i['phones'][0]['number']
                    creation_date = i['creationDate']
                    added = i['added']
                    description = i['description']
                    year_of_building = i['building']['buildYear']
                    try:
                        materialType = i['building']['materialType']
                    except:
                        materialType = ''
                    add_info = i['formattedAdditionalInfo']
                    isnew = i['isNew']
                    ...
                    result = [added, creation_date, project, developer, location, location2, okrug, raion, mikroraion, metro, street, house,
                              korpus, distance, srok_sdachi, type,
                              finish_type, room_count, area, kitchenArea, livingArea, price, floor,
                              balconies_and_loggias_count, parking, phone, url, description, year_of_building, materialType, add_info, isnew]
                    flats.append(result)
            ...
            if len(flats) > 1:
                ...
                df = pd.DataFrame(flats, columns=['Дата обновления', 'Дата создания',
                                                  'Название проекта',
                                                        'Девелопер',
                                                        'Локация',
                                                        'Локация2',
