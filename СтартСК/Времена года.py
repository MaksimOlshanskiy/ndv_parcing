...
for f in flats_soup:
    ...
    area = float(f.find_all('span', class_='_valueLabel_1wspg_24')[2].text.split(' м')[0])
    price_per_metr = ''
    ...
    section = ''
    floor = int(f.find_all('span', class_='_valueLabel_1wspg_24')[0].text.split('/')[0])
    flat_number = ''
