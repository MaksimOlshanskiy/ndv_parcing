...
url = 'https://napatriarshih.com/the-patricks'
...
if response.status_code == 200:
    ...
    for flat in flats:
        ...
        price_ppm_tag=price_tag.find('div', class_='f-object__price-per-meter') if price_tag else None
        ppm=price_ppm_tag.get_text(strip=True) if price_number_tag else ''
        ...
        ppm=int(ppm.replace(' рублей за м2', '').replace(' ', ''))
        developer = 'Третий Рим'
