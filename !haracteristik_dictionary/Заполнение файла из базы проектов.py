...
df = pd.read_excel(r"C:\Users\m.olshanskiy\Desktop\База Сентябрь\База 08.xlsx")
...
df.to_excel(r"C:\Users\m.olshanskiy\Desktop\База Сентябрь\База 08-2.xlsx", index=False)