...
file_path = r"C:\Users\Mi\OneDrive\Desktop\База\Feb-april.xlsx"
...
columns_to_fill = ['на англ', 'промзона', 'Местоположение',
                   ...
                   'Округ', 'Район', 'Адрес', 'Эскроу', 'статус']
...
# Сохраняем результат
output_path = r"C:\Users\Mi\OneDrive\Desktop\База\Feb-april_filled.xlsx"
