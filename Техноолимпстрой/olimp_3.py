...
'''
в params меняем access_token по ссылке https://klin.tolimp.ru/apartments#/profitbase/projects/genplans?filter=project:5865&filter=property.status:AVAILABLE&genplanId=203
'''
...
params = {
    ...
    'access_token': '193af1f0e756f500458f222c10c86f7bc57b061bbb5d7ce53f462f51e08f4d12',
}
        ...
        if response.status_code == 200:
            ...
            for prop in properties:
                try:
                    ...
                    korpus = prop.get("houseName", "").split(' ')[0]
                    type_ = 'Квартира'
