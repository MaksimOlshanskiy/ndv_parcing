...
def parse_flats():
    ...
    base_params = {
        'arFilterFlat_134': '',
        'arFilterFlat_135': '93300731',
        'arFilterFlat_571': '',
        'arFilterFlat_122': '',
        'arFilterFlat_123': '',
        'arFilterFlat_124_MIN': '38.1',
        'arFilterFlat_124_MAX': '234.5',
        'arFilterFlat_570_MIN': '5.9',
        'arFilterFlat_570_MAX': '633.3',
        'set_filter': 'Y',
        'PAGEN_1': '1',
    }
    ...
    try:
            ...
            for card in current_page_flats:
                try:
                    ...
                    flat_data = {
                        ...
                        'Название проекта': 'Резиденции Воронцова',
                        'на англ': '',
                        'промзона': '',
                        'Местоположение': '',
                        'Метро': '',
        ...
        save_flats_to_excel(flats_data, 'Резиденции Воронцова', 'ГК Развитие')
