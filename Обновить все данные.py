...
def update_all_base():
    ...
    if os.path.exists(r"/!changing_haracteristik_dictionary/projects555.json"):
        with open(r"/!changing_haracteristik_dictionary/projects555.json", "r", encoding="utf-8") as f:
    ...
    # сохраняем новый JSON
    with open(r"!changing_haracteristik_dictionary/projects555.json", "w", encoding="utf-8") as f:
