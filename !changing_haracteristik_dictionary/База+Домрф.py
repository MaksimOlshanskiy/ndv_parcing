...
# Загружаем файлы
df1 = pd.read_excel(r"\\192.168.252.25\аналитики\ОТЧЕТЫ\База изменяемые данные_NEWW.xlsx")
...
# Сохраняем результат
merged.to_excel(r"\\192.168.252.25\аналитики\ОТЧЕТЫ\База изменяемые данные_NEWW2.xlsx", index=False)
