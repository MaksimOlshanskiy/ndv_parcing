...
merged = (
    merged.drop(columns=['Срок сдачи'], errors='ignore')
      .rename(columns={'Ввод в эксплуатацию': 'Срок сдачи'})
)
col = 'Ссылка'
...
not_entered = merged['Стадия строительной готовности'] != 'введен'

# 1. Завершающий цикл — самый приоритетный
mask_stage3 = (
    not_entered
    & merged['stage_3_date'].notna()
    & (today > merged['stage_3_date'])
)
